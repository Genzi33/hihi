...
def tokenz():
	...
	try:
		...
		os.system('clear')
		logo()
		print('Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï)
		token = input(' [?] token : ')
		try:
...
def menu():
    ...
    logo()
    print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï'%(O))
 ...
 #   print(" %s[%s+%s] %sTgl. Lahir  : %s"%(O,H,O,N,ttl))
    ...
    print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
...
def cekopsi():
	dirs = os.listdir("CP")
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€'%(O))
	for file in dirs:
		print(" %s[%s*%s] %sCP/%s"%(O,H,O,K,file))
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€'%(O))
...
### CEK HASIL ### 
def cekhasil():
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
	...
	if anjg == '':
		...
		print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
		...
		print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
		input(" %s[%s*%s] %stekan enter untuk kembali ke menu "%(O,H,O,N))
		menu()
	else:
		menu()
...
def publik():
	...
	if idt in[""]:
		menu()
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
...
### ATUR SANDI ###
def atursandi():
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
...
def munculopsi():
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
...
def otomatis():
	...
	if ask=="":
		...
		print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
		...
		print(' %s[%s+%s] %shasil %sOK %sdisimpan ke -> %sok.txt'%(O,H,O,N,H,N,H))
		print(' %s[%s+%s] %shasil %sCP %sdisimpan ke -> %scp.txt'%(O,K,O,N,K,N,K))
		print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
		with ThreadPoolExecutor(max_workers=30) as fall:
			for user in id:
				uid, name = user.split("<=>")
				nam = name.split(' ')
		...
		print(' %s[%s+%s] %shasil %sOK %sdisimpan ke -> %sok.txt'%(O,H,O,N,H,N,H))
		print(' %s[%s+%s] %shasil %sCP %sdisimpan ke -> %scp.txt'%(O,K,O,N,K,N,K))
		print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
		with ThreadPoolExecutor(max_workers=30) as fall:
			for user in id:
				uid, name = user.split("<=>")
				nam = name.split(' ')
...
def gabungkan():
	...
	print(" %s[%s3%s]. %smetode mobile [%svery slow%s]"%(O,H,O,N,K,N))
	print(" %s[%s4%s]. %smetode graph [%ssuper slow hef%s]"%(O,H,O,N,H,N))
	print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
	ask=input(" %s[%s?%s] %spilih :%s "%(O,H,O,N,H))
	if ask=="":
		exit(" %s[!] isi jawaban dengan benar!"%(M))
	elif ask=="1":
		print(' %s[%s+%s] %shasil %sOK %sdisimpan ke -> %sok.txt'%(O,H,O,N,H,N,H))
		print(' %s[%s+%s] %shasil %sCP %sdisimpan ke -> %scp.txt'%(O,K,O,N,K,N,K))
		print('%sÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€ÏÏ€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€Ï€'%(O))
		with ThreadPoolExecutor(max_workers=30) as fall:
			for user in id:
				uid, name = user.split("<=>")
				nam = name.split(' ')
